...
//		con.setRequestProperty("content-type", "text/html");
	...
	public static void main(String[] args) throws Exception {
		String xml="<xml><ToUserName>ziroomer</ToUserName><FromUserName>chengxiaojian_</FromUserName><CreateTime>"+System.currentTimeMillis()+"</CreateTime><MsgType>text</MsgType><Content>2</Content></xml>";
