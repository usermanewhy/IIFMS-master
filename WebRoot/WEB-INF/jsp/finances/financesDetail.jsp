...
<body>
	...
	<table border="0">
		...
		<tr>
			...
			<td colspan="5" class="t_text w520" >
			 <div id="dd" style=" width:660px;" class="">
				<c:forEach items="${financesImg}" var="image">
                <div style="float:left"> 
                <img id="img${image.id}" src="http://localhost:8080/IIFMS${image.imageUrl}" style="display: block; width: 163px; height: 163px; margin-top: 2px; margin-left: 2px;">
                </div>
				</c:forEach>
			</div>
			</td>
